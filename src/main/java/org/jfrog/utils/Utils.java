...
public class Utils {
    ...
    public static License getLicense(com.jfrog.xray.client.services.summary.License other) {
    ...
    public static Issue getIssue(com.jfrog.xray.client.services.summary.Issue other) {
    ...
    public static Artifact getArtifact(com.jfrog.xray.client.services.summary.Artifact other) {
        ...
        Set<Issue> issues = other.getIssues().stream().map(Utils::getIssue).collect(Collectors.toSet());
        Set<License> licenses = other.getLicenses().stream().map(Utils::getLicense).collect(Collectors.toSet());
